...
public class SumasProxy implements com.mx.everis.tallerjava.service.Sumas {
  private String _endpoint = null;
  private com.mx.everis.tallerjava.service.Sumas sumas = null;
  ...
  private void _initSumasProxy() {
    try {
      sumas = (new com.mx.everis.tallerjava.service.SumasServiceLocator()).getSumas();
      if (sumas != null) {
        if (_endpoint != null)
  ...
  public com.mx.everis.tallerjava.service.Sumas getSumas() {
    if (sumas == null)
      _initSumasProxy();
    return sumas;
  }
